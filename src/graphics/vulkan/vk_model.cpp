...
LVEVulkanModel::LVEVulkanModel(LVEVulkanDevice &device, const std::vector<Vertex> &verticies) : vulkanDevice{ device } {
...
void LVEVulkanModel::createVertexBuffers(const std::vector<Vertex> &verticies) {
	...
	void *data;
	vkMapMemory(vulkanDevice.device(), vertexBufferMemory, 0, vertexBufferSize, 0, &data);
...
std::vector<VkVertexInputBindingDescription> LVEVulkanModel::Vertex::getBindingDescription() {
